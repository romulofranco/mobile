...
public final class Font {
  ...
  public static int getDefaultFontSize() {
    ...
    int w, h;
    w = (int) (Math.min(Settings.screenWidth, Settings.screenHeight) / Settings.screenDensity);
    h = (int) (Math.max(Settings.screenWidth, Settings.screenHeight) / Settings.screenDensity);
