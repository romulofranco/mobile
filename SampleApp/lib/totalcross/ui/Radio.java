...
public class Radio extends Control implements TextControl, MaterialEffect.SideEffect {
  ...
  public void onPaint(Graphics g) {
    ...
    for (int i = 0; i < lines.length; i++, yy += fmH) {
      g.drawText(lines[i], leftJustify? xx : this.width - fm.stringWidth(lines[i]), yy, textShadowColor != -1, textShadowColor);
    }
  } //onPaint
  ...
  {
    displayedText = Convert.insertLineBreak(maxWidth, fm, text); // guich@tc126_18: text cannot be assigned here or originalText will be overwritten
