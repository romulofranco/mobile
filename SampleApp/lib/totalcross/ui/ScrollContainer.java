        ...
        resetTarget();
         ...
         if (sbH != null) {
            if (targetX < sbH.getMinimum()) {
             ...
             willScroll = false;
            } else if (targetX > sbH.getMaximum()-this.width) {
             targetX = sbH.getMaximum()-this.width;
               willScroll = false;
            }
         } else {
            willScroll = false;
         ...
         if (sbV != null) {
            if (targetY < sbV.getMinimum()) {
               ...
               willScroll = false;
            } else if (targetY > sbV.getMaximum()-this.height) {
               targetY = sbV.getMaximum()-this.height;
               willScroll = false;
            }
         } else {
            willScroll = false;
